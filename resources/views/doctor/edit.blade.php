    ...
    <div class="col-md-4 col-xl-3">
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <div class="card-body text-center">
                    @if ($doctor->image)
                    <img src="{{asset('storage/' . $doctor->image)}}" alt="{{$doctor->name}}" id="img-preview"
                        class="img-fluid rounded-circle mb-2" width="128" height="128">
                    @else
                    <img id="img-preview" src="{{asset('img/default.png')}}"
                        class="img-preview img-fluid rounded-circle mb-2" width="128" height="128">
                    @endif
                </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('specialist') is-invalid @enderror" id="specialist"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('phonenumber') is-invalid @enderror"
                        id="phonenumber" name="phonenumber" value="{{old('phonenumber', $doctor->phonenumber)}}">
                    @error('phonenumber')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('accepted') is-invalid @enderror" id="accepted"
                        name="accepted" value="{{old('accepted', $doctor->accepted)}}">
                    @error('accepted')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
