<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="/">
            <span class="align-middle">Rekam Medis</span>
        </a>
        ...
        <ul class="sidebar-nav">
            ...
            @if (auth()->user()->role == 'Admin' || auth()->user()->role == 'Dokter' || auth()->user()->role ==
            'Pegawai')
            ...
            <li class="sidebar-item {{Request::is('form*') ? 'active' : ''}}">
                <a class="sidebar-link" href="/form">
                    <i class="align-middle" data-feather="pie-chart"></i> <span class="align-middle">Bentuk &
                        Sediaan</span>
                </a>
            </li>
