        ...
        <div class="card flex-fill">
            ...
            <table class="table table-hover my-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/patient/{{$patient->id}}" class="btn btn-info btn-sm"><i
                                    data-feather="eye"></i></a>
                            <a href="/patient/{{$patient->id}}/edit" class="btn btn-warning btn-sm"><i
            ...
            <div class="d-flex justify-content-center mb-2">
                <div class="alert alert-secondary col-11" role="alert">
                    Tabel pasien masih kosong <a href="/patient/create" class="alert-link">klik tombol <strong
                            class="text-success">Tambah</strong></a> untuk menambah pasien.
                </div>
            </div>
            @endif
        </div>
