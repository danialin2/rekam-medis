    ...
    <div class="col-md-4 col-xl-3">
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                <img src="{{asset('storage/' . $schedule->doctor->image)}}" alt="{{$schedule->doctor->name}}"
                    class="img-fluid rounded-circle mb-2" width="128" height="128" />
                @else
                <img src="{{asset('img/default.png')}}" alt="{{$schedule->doctor->name}}"
                    class="img-fluid rounded-circle mb-2" width="128" height="128">
                @endif
                ...
                <div>
                    ...
                    <a class="btn btn-warning btn-sm" href="/doctor/{{$schedule->id}}/edit"><i
                            data-feather="edit"></i></a>
                    <a class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#comfirmModal"><i
            ...
            <div class="card-body">
                ...
                <p>
                    <i data-feather="file-plus"></i><small> Dibuat
                        {{$schedule->doctor->created_at->diffForHumans()}}</small>
                </p>
                <p>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="day" name="day" value="{{$schedule->day->name}}"
                                readonly>
                        </div>
                        <div class="mb-3">
                            <label for="id" class="form-label">No Dokter</label>
                            <input type="number" class="form-control" id="id" name="id"
                                value="{{$schedule->doctor->id}}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="phonenumber" class="form-label">No Handphone</label>
                            <input type="number" class="form-control" id="phonenumber" name="phonenumber"
                                value="{{$schedule->doctor->phonenumber}}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="accepted" class="form-label">Tanggal Diterima</label>
                            <input type="date" class="form-control" id="accepted" name="accepted"
                                value="{{$schedule->doctor->accepted}}" readonly>
                        </div>
                    </div>
                    <div class="col-md">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                value="{{$schedule->doctor->name}}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="specialist" class="form-label">Spesialis</label>
                            <input type="text" class="form-control" id="specialist" name="specialist"
                                value="{{$schedule->doctor->specialist}}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="gender" class="form-label">Jenis Kelamin</label>
                            <input type="text" class="form-control" id="gande" name="gande"
                                value="{{$schedule->doctor->gender->gender}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="address" id="address" rows="2"
                        readonly>{{$schedule->doctor->address}}</textarea>
                </div>
                <div class="mt-3 d-flex justify-content-end">
                    ...
                    @endif
                    <div class="modal fade" id="comfirmModal" tabindex="-1" aria-labelledby="comfirmModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <p class="text-danger modal-title fs-5" id="staticBackdropLabel">
