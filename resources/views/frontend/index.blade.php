...
<body>
    ...
    <header id="header" class="fixed-top header-transparent header-scrolled">
        <div class="container d-flex align-items-center justify-content-between position-relative">
            ...
            <div class="logo">
                <h1 class="text-light"><a href="index.html"><span>rekam Medis</span></a></h1>
    ...
    <section id="hero">
        ...
        <div class="hero-container" data-aos="fade-up">
            ...
            <h2>Memberikan pelayanan kesehatan terbaik</h2>
                ...
                <div class="row no-gutters">
                    <div class="content col-xl-5 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="content">
                            ...
                            <p>
                                Rumah Sakit Tk. IV Cijantung didirikan pada tahun 2001 untuk memberikan pelayanan
                                kesehatan terbaik bagi prajurit TNI AD & keluarga serta untuk masyarakat luas. Rumah
                                sakit ini dikelola oleh TNI AD.
                            </p>
        ...
        <!-- <section id="services" class="services">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-in" data-aos-delay="100">
                    <h2>Layanan</h2>
                    <p>Dengan Dokter-Dokter Spesialis yang kompeten, kami berupaya untuk memberikan pelayanan medis yang
                        tepat untuk setiap kebutuhan kesehatan anda.</p>
                </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="{{$patients->count()}}"
                    ...
                    <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="{{$records->count()}}"
                                data-purecounter-duration="1" class="purecounter"></span>
                    ...
                    <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="{{$employees->count()}}"
                                data-purecounter-duration="1" class="purecounter"></span>
                ...
                <div class="row">
                    <div class="col-lg d-flex">
                        <div class="card flex-fill">
                            ...
                            @if ($schedules->count())
                            <table class="table table-hover align-middle mb-0 bg-white my-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <p class="fw-bold mb-1">{{$schedule->doctor->name}}</p>
                                        ...
                                        <td>@php
                                            $dayName = strtolower($schedule->day->name);
                                            $color = '';
                                            ...
                                            break;
                                            case 'sabtu':
                                            $color = '#1abc9c'; // Warna turkis
                                            break;
                                            case 'minggu':
                                            $color = '#2f4d5a'; // Warna oranye
                                            break;
                                            }
                                            @endphp

                                            <span class="badge rounded-pill d-inline"
                                                style="background-color: {{$color}}">{{$schedule->day->name}}</span>
                                        </td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg ">
                        <iframe class="mb-4 mb-lg-0"
                            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15862.664516944847!2d106.8588289!3d-6.3075204!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ed84a722b499%3A0x7328038f8b24483e!2sRumah%20Sakit%20Kesdam%20Jaya%20Cijantung!5e0!3m2!1sid!2sid!4v1702890424171!5m2!1sid!2sid"
